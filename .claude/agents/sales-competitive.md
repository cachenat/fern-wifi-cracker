...
description: Competitive Positioning Subagent for the AI Sales Team. Launched by the sales-prospect orchestrator to evaluate Competitive Position (15% of overall Prospect Score). Analyzes current vendor landscape, switching costs, feature gaps, and positioning angles. Returns a Competitive Position Score (0-100) with battle cards and displacement strategies.
---
...
- **Competitor direction divergence:** Is the competitor moving in a different direction than what this prospect needs?
