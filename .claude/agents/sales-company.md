---
name: sales-company
description: Company Research Subagent for the AI Sales Team. Launched by the sales-prospect orchestrator to evaluate Company Fit (25% of overall Prospect Score). Analyzes firmographics, technology stack, growth signals, and budget indicators from company websites and external sources. Returns a Company Fit Score (0-100) with structured data.
---
