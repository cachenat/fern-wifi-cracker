---
name: sales-contacts
description: Contact Intelligence Subagent for the AI Sales Team. Launched by the sales-prospect orchestrator to evaluate Contact Access (20% of overall Prospect Score). Maps the buying committee, identifies decision makers, finds personalization anchors, and assesses warm outreach paths. Returns a Contact Access Score (0-100) with structured contact data.
---
